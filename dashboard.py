...
def servers():
    ...
    for g in manageable:
        ...
        if is_bot_in:
            ...
            invite_url = f"https://discord.com/api/oauth2/authorize?client_id={CLIENT_ID}&permissions=2416299008&scope=bot%20applications.commands&guild_id={g['id']}&disable_guild_select=true"
