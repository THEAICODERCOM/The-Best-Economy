...
from shared.constants import DEFAULT_BANK_PLANS, DEFAULT_ASSETS
...
async def increment_quests(user_id, guild_id, command_name=None):
    ...
    async with aiosqlite.connect(DB_FILE) as db:
        ...
        from bot.services.economy_service import EconomyService as _EconomyService
        _econ = _EconomyService()
...
from bot.commands.owner import setup_owner_commands
setup_owner_commands(bot)
...
from bot.commands.boss import setup_boss_commands
from bot.commands.quests import setup_quests_commands
from bot.commands.profile import setup_profile_commands
from bot.commands.assets import setup_assets_commands
setup_assets_commands(bot)
from bot.core.task_manager import TaskManager
from bot.systems.boss.worker import BossWorker
